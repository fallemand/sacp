...
class TreatmentsController {
    constructor($state, Auth) {
        ...
        this.treatmentsTable = {
            ...
            privileges: {
                user: {
                    actions: ['view', 'modify', 'view-prescription'],
                    list: 'mine'
                },
            ...
            customActions: {
                ...
                'view-prescription' : function(row) {
                    return (row.state._id === 'AP') ? '<a class="btn btn-xs btn-success" ng-click="vm.download(\'prescription\', \'' + row._id + '\')" uib-tooltip="Ver Receta" tooltip-placement="top" tooltip-append-to-body="true"><i class="fa fa-navicon"></i></a>' : '';
                }
            },
            canFilter : true,
