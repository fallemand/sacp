        ...
        this.treatmentsTable = {
            ...
            customActions: {
                ...
                'view-prescription' : function(row) {
                    return (row.state._id === 'AP') ? '<a class="btn btn-xs btn-success" ng-click="vm.download(\'/api/reports/prescription/' + row._id + '\')" uib-tooltip="Ver Receta" tooltip-placement="top" tooltip-append-to-body="true"><i class="fa fa-navicon"></i></a>' : '';
                }
            },
            canFilter : true,
