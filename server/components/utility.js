...
// This is your API key that you retrieve from www.mailgun.com/cp (free up to 10K monthly emails)
    var auth = {
        auth: {
            ...
            domain: 'sandbox6be86ca8b66842079b4b85683ffb92b0.mailgun.org'
        }
    }
    ...
    nodemailerMailgun.sendMail({
        from: 'postmaster@sandbox6be86ca8b66842079b4b85683ffb92b0.mailgun.org',
        to: 'facualle@hotmail.com', // An array if you have multiple recipients.
